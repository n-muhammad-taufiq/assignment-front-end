  ...
  return (
    ...
    <div className={`${!shouldOpenMenu ? 'max-lg:hidden' : 'slide-left-right'} flex flex-col h-screen border-r-2 border-r-gray-200 bg-slate-50 pt-5 pr-3 gap-y-7 pl-4 max-lg:relative max-lg:slide-left-right max-lg:w-fit max-lg:h-full max-lg:border-r max-lg:border-r-gray-100 px-3 `}>
      ...
      <div className='flex flex-col gap-y-2 font-bold text-xs text-gray-800 pr-10'>
          ...
          <svg className={`h-4 w-4  stroke-1 fill-slate-50 ${currentOption==='Telemedicine' ? 'stroke-black' : 'stroke-gray-700'}`}  version="1.1" id="Icons" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" 
          ...
          <path d="M20 11H4M20 11V19C20 20.1046 19.1046 21 18 21H6C4.89543 21 4 20.1046 4 19V7C4 5.89543 4.89543 5 6 5H18C19.1046 5 20 5.89543 20 7V11ZM15 3V7M9 3V7" stroke-linecap="round" stroke-linejoin="round"/>
          </svg>
          <p>Appointments</p>
          </div>
          ...
          <svg className={`h-4 w-4 stroke-1 ${currentOption==='Medical Services' ? 'fill-black' : 'fill-gray-700 stroke-gray-700'}`} viewBox="0 0 64 64" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
          ...
          <g id="64px-Line"  fill-rule="evenodd">
          <g id="gen-heart-rate">
