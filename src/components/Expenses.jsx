    ...
    const renderExpenses=()=>{
        ...
        return (
            <div className='flex flex-col w-full items-center gap-y-5'>
                <div style={{borderColor:expenses[0].borderColor}} className='h-72 w-72 border-4 rounded-full p-4 flex items-center justify-center'>
                    <div style={{borderColor:expenses[1].borderColor}} className='h-64 w-64 border-4 rounded-full p-4 flex items-center justify-center'>
                        <div style={{borderColor:expenses[2].borderColor}} className='h-56 w-56 border-4 rounded-full p-4 flex flex-col gap-y-3 items-center justify-center font-bold'>
                            <p>Total</p>
                            <p className='text-2xl'>₹{expensesData.totalExpenses}</p>
                        </div>
                    </div>
                </div>
