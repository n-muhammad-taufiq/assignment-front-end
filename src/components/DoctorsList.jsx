...
const DoctorsList = ({allDoctors,doctors,setAllDoctors}) => {
  ...
  return (
    ...
    &&
    <button className='flex gap-x-2 mt-0.5 items-center justify-center cursor-pointer hover:opacity-50 duration-500'>
    ...
    <table className='max-w-full'>
        ...
        <tbody>
            {doctors?.map((doctor,index)=>(
                ...
                setActionStatus={setActionStatus} handleDeleteDoctor={handleDeleteDoctor}></Doctor>
            ))}
        </tbody>    
    </table>
